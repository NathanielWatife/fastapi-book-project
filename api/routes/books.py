# filepath: /Users/mac/Documents/Projects/hngprojects/fastapi-book-project/api/routes/books.py
...
async def get_book_by_id(book_id: int):
    book = next((book for book in db.books.values() if book.id == book_id), None)
    if not book:
